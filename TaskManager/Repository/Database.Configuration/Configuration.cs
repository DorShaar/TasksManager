...
namespace Database.Configuration
{
    ...
    public class Configuration : IConfiguration
    {
        ...
        public string NotesTasksDirectoryPath { get => GetTasksNotesPathNode(LoadYamlStream()).Value; }
        ...
        private YamlScalarNode GetTasksNotesPathNode(YamlStream yamlStream)
        {
            YamlMappingNode rootNode = (YamlMappingNode)yamlStream.Documents[0].RootNode;
            var pathKeyValueNode = rootNode.Children[new YamlScalarNode("database")];
            return (YamlScalarNode)(pathKeyValueNode as YamlMappingNode).Children[new YamlScalarNode("tasks_notes_path")];
        }
